...
SYMBOLS = ["XAUUSD"]  # XAUEUR/XAUGBP disabled
...
BACKTEST_TIMEFRAME = os.getenv("BACKTEST_TIMEFRAME", "M5")
...
BACKTEST_COMMISSION_USD = float(os.getenv("BACKTEST_COMMISSION_USD", 1.0))
